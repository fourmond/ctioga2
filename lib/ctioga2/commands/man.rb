...
module CTioga2
  ...
  Version::register_svn_info('$Revision: 951 $', '$Date: 2009-04-18 22:30:41 +0200 (Sat, 18 Apr 2009) $')
  ...
  module Commands
    ...
    class Help2Man
      ...
      # The Help object Help2Man should be working on.
      attr_accessor :help
      ...
      def write_manual_page(version, input, out = STDOUT)
        ...
        @cmds, @groups = @help.documented_commands
        @cmd_exclude = {}
        @group_exclude = {}
      ...
      WriteManualPage = 
        ...
        h2m = Help2Man.new(plotmaker.interpreter.help)
        h2m.write_manual_page(version, file)
      end
      
      WriteManualPage.describe("Writes a skeleton for a manual page",
                               <<EOH, DocumentationGenerationGroup)
Writes the skeleton of a manual page.
EOH
